<?php if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    $status = $_POST['Status'];
$sql = "update tbl_pengajuancuti set JenisCuti ='$jeniscuti', AlasanCuti ='$alasan', DurasiCuti ='$durasi', TanggalMulaiCuti ='$tglmulai', TanggalCutiSelesai ='$tglselesai', AlamatKetikaCuti ='$alamat' where KodePengajuanCuti='$kodecuti'";
